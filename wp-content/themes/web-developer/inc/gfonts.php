...
function web_developer_custom_styles($custom) {
	//Fonts
	...
	wp_add_inline_style( 'web-developer-basic-style', $custom );
}
add_action( 'wp_enqueue_scripts', 'web_developer_custom_styles' );

//Sanitizes Fonts
function web_developer_sanitize_fonts( $input ) {
	$valid = array(
